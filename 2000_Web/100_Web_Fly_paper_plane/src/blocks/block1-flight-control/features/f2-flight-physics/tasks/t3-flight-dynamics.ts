...
export const THRUST_FORCE = 200       // Newtons (increased for 10kg plane)
export const DRAG_COEFFICIENT = 0.5   // Drag factor (increased for stability)
export const LIFT_COEFFICIENT = 2.0   // Lift factor (increased for better flight)
