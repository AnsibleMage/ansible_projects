...
**버전:** 1.2
**작성일:** 2025-11-07
**최종 업데이트:** 2025-11-08 23:30 (Block 4 추가 반영)
...
> 💡 **v1.2 핵심 철학**: "Plan → Execute → Discover → Adapt"
> 방법론은 고정된 규칙이 아니라 프로젝트 현실에 적응하는 **살아있는 가이드**입니다.
...
- **적응성** (프로젝트 특성에 따라 구조 조정) ⭐ v1.2 추가

이 네 가지를 **계층적으로 통합**합니다.
...
**주요 변화 (v1.2)**:
- "1 Product = 3 Blocks"를 가이드라인으로 명시 (고정 규칙 ❌)
- "1 Product = N Blocks = M Features = K Tasks" 공식 도입
- 실제 프로젝트 사례 추가 (7100_Fly_paper_plane: 3→4 Blocks 확장)
- FAQ Q5 추가: "Block은 항상 3개여야 하나요?"
- Adaptive Methodology 원칙 강조

---

**마지막 업데이트:** 2025-11-08 23:30 (Block 4 추가 반영, v1.2 확정)
